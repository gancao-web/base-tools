  ...
  for (const file of requiredFiles) {
    ...
    if (!exists) {
      ...
      if (file.endsWith('.js')) {
        ...
        const hasUMD = content.includes('(function') || content.includes('!function') || content.includes('var ');
        ...
        if (file.includes('base-tools-web')) {
          const hasBaseToolsWeb = content.includes('baseToolsWeb') || content.includes('setLocalStorage');
